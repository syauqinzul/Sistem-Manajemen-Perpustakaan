...
const bookTitles = [
    ...
    'Eloquent JavaScript', 'You Don\'t Know JS', 'Design Patterns',
    'Refactoring: Improving the Design of Existing Code', 'Introduction to Algorithms',
    'The Clean Coder', 'Code Complete', 'Structure and Interpretation of Computer Programs',
    'The Mythical Man-Month', 'Head First Design Patterns', 'Programming Pearls',
    'The Art of Computer Programming', 'Cracking the Coding Interview',
    'Domain-Driven Design', 'Working Effectively with Legacy Code',
    'Test-Driven Development', 'The Software Craftsman',
    
    // Fiksi & Sastra (15 buku)
    'Laskar Pelangi', 'Sang Pemimpi', 'Edensor', 'Pulang', 'Pergi',
    'Bumi Manusia', 'Anak Semua Bangsa', 'Rumah Kaca', 'Arok Dedes',
    'Hujan', 'Mata di Tanah Melus', 'Negeri 5 Menara', 'Ranum 1',
    'Cantik itu Luka', 'Ronggeng Dukuh Paruk',
    
    // Sains & Non-Fiksi (15 buku)
    'Sapiens: Riwayat Singkat Umat Manusia', 'Homo Deus: Masa Depan Umat Manusia',
    '21 Lessons for the 21st Century', 'Cosmos', 'A Brief History of Time',
    'The Selfish Gene', 'The Emperor of All Maladies', 'Guns, Germs, and Steel',
    'Thinking, Fast and Slow', 'Outliers: The Story of Success',
    ...
    'Sejarah Indonesia Modern', 'Revolusi Indonesia', 'Bung Karno: Penyambung Lidah Rakyat',
    'Soeharto: Biografi Singkat', 'Tan Malaka: Bapak Republik yang Dilupakan',
    'Kartini: Habis Gelap Terbitlah Terang', 'Steve Jobs', 'Elon Musk: Tesla, SpaceX',
    'The Diary of a Young Girl', 'Long Walk to Freedom',
    
    // Bisnis & Ekonomi (10 buku)
    'Rich Dad Poor Dad', 'The Intelligent Investor', 'The Lean Startup',
    'Zero to One', 'Good to Great', 'The 4-Hour Workweek',
    'Thinking in Bets', 'The Psychology of Money', 'The Millionaire Next Door',
    'Business Adventures',
    
    // Sains Populer & Pendidikan (10 buku)
    'Fisika untuk Pemula', 'Kimia Dasar', 'Biologi Molekuler',
    'Matematika Diskrit', 'Statistika Terapan', 'Kalkulus',
    'Astronomi untuk Semua', 'Neuroscience: Exploring the Brain',
    'The Code Book', 'The Elegant Universe',
    
    // Fiksi Internasional (10 buku)
    'To Kill a Mockingbird', '1984', 'Pride and Prejudice',
    'The Great Gatsby', 'One Hundred Years of Solitude',
    'Brave New World', 'The Catcher in the Rye', 'The Alchemist',
    'The Little Prince', 'Harry Potter and the Philosopher\'s Stone',
    
    // Agama & Spiritual (10 buku)
    'Al-Quran dan Terjemahan', 'Hadis Arbain', 'Mengenal Diri melalui Tasawuf',
    'The Power of Now', 'The Art of Happiness', 'Man\'s Search for Meaning',
    'The Road Less Traveled', 'The Four Agreements', 'The Celestine Prophecy',
    'The Secret'
];

const bookAuthors = [
    // Penulis Teknologi
    'Douglas Crockford', 'Robert C. Martin', 'Andrew Hunt', 'Marijn Haverbeke',
    'Kyle Simpson', 'Erich Gamma', 'Martin Fowler', 'Thomas H. Cormen',
    'Robert C. Martin', 'Steve McConnell', 'Harold Abelson',
    'Frederick P. Brooks', 'Eric Freeman', 'Jon Bentley',
    'Donald Knuth', 'Gayle Laakmann McDowell', 'Eric Evans',
    'Michael Feathers', 'Kent Beck', 'Sandro Mancuso',
    
    // Penulis Indonesia
    'Andrea Hirata', 'Andrea Hirata', 'Andrea Hirata', 'Tere Liye',
    'Tere Liye', 'Pramoedya Ananta Toer', 'Pramoedya Ananta Toer',
    'Pramoedya Ananta Toer', 'Pramoedya Ananta Toer', 'Tere Liye',
    'Okky Madasari', 'Ahmad Fuadi', 'Laksmi Pamuntjak',
    'Eka Kurniawan', 'Ahmad Tohari',
    
    // Penulis Sains & Non-Fiksi
    'Yuval Noah Harari', 'Yuval Noah Harari', 'Yuval Noah Harari',
    'Carl Sagan', 'Stephen Hawking', 'Richard Dawkins',
    'Siddhartha Mukherjee', 'Jared Diamond', 'Daniel Kahneman',
    'Malcolm Gladwell', 'Charles Duhigg', 'James Clear',
    'Cal Newport', 'Stephen R. Covey', 'Dale Carnegie',
    
    // Penulis Sejarah & Biografi
    'M.C. Ricklefs', 'Benedict Anderson', 'Cindy Adams',
    'O.G. Roeder', 'Harry A. Poeze', 'Armijn Pane',
    'Walter Isaacson', 'Ashlee Vance', 'Anne Frank',
    'Nelson Mandela',
    
    // Penulis Bisnis
    'Robert Kiyosaki', 'Benjamin Graham', 'Eric Ries',
    'Peter Thiel', 'Jim Collins', 'Tim Ferriss',
    'Annie Duke', 'Morgan Housel', 'Thomas J. Stanley',
    'John Brooks',
    
    // Penulis Pendidikan
    'Prof. Dr. Anwar', 'Dr. Budi Santoso', 'Dr. Sari Dewi',
    'Prof. Joko Widodo', 'Dr. Linda Susanti', 'Prof. Ahmad',
    'Dr. Brian Cox', 'Mark F. Bear', 'Simon Singh',
    'Brian Greene',
    
    // Penulis Fiksi Internasional
    'Harper Lee', 'George Orwell', 'Jane Austen',
    'F. Scott Fitzgerald', 'Gabriel García Márquez',
    'Aldous Huxley', 'J.D. Salinger', 'Paulo Coelho',
    'Antoine de Saint-Exupéry', 'J.K. Rowling',
    
    // Penulis Spiritual
    'Tim Kementerian Agama', 'Imam Nawawi', 'Prof. Dr. Quraish Shihab',
    'Eckhart Tolle', 'Dalai Lama', 'Viktor Frankl',
    'M. Scott Peck', 'Don Miguel Ruiz', 'James Redfield',
    'Rhonda Byrne'
];

const bookGenres = [
    'Teknologi', 'Programming', 'Computer Science', 'Software Engineering',
    'Fiksi', 'Sastra', 'Roman', 'Drama', 'Sejarah', 'Biografi',
    'Sains', 'Populer Science', 'Filsafat', 'Psikologi',
    'Bisnis', 'Ekonomi', 'Keuangan', 'Entrepreneurship',
    'Pendidikan', 'Matematika', 'Fisika', 'Kimia', 'Biologi',
    'Sejarah', 'Politik', 'Budaya', 'Agama', 'Spiritual',
    'Self-Help', 'Pengembangan Diri', 'Motivasi',
    'Fantasi', 'Misteri', 'Petualangan', 'Klasik'
];
...
function renderBooks(bookArray = books) {
    ...
    if (bookArray.length > itemsPerPage) {
        ...
        paginationInfo.innerHTML = `
            <p>Menampilkan ${startIndex + 1}-${endIndex} dari ${bookArray.length} buku</p>
    ...
    if (bookArray.length === 0) {
        ...
        emptyMessage.innerHTML = '<div class="book-title">Tidak ada buku dalam koleksi</div>';
...
function updateStatistics() {
    ...
    // Log statistics
    console.log(`📊 Statistik: Total=${books.length}, Tersedia=${availableCount}`);
}
    ...
    if (target.classList.contains('delete-btn')) {
        ...
        if (bookId >= 0 && bookId < books.length) {
            ...
            if (confirm(`Apakah Anda yakin ingin menghapus buku "${bookTitle}"?`)) {
                ...
                showNotification(`Buku "${removedBook.title}" telah dihapus`, 'warning');
                renderBooks();
            }
        }
    }
...
function handleShowAvailableBooks() {
    ...
    showNotification(`Menampilkan ${availableBooks.length} buku tersedia`, 'info');
}
...
function handleSortByYear() {
    ...
    showNotification('Buku diurutkan berdasarkan tahun (tertua → terbaru)', 'info');
}
...
function handleResetData() {
    ...
    if (confirm(`Apakah Anda yakin ingin menghapus semua ${books.length} buku?`)) {
        books = [];
...
function searchBooks(keyword) {
    ...
    renderBooks(results);
    showNotification(`Ditemukan ${results.length} buku untuk "${keyword}"`, 'info');
}
